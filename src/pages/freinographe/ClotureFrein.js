...
export default class ClotureFrein extends React.Component {
	constructor(props) {
		super(props);
  ...
  async newFormation(){
	try {
		...
		// let studentEvalue = await AsyncStorage.getItem('f_student_evalue')
		...
		// 	console.log(el);
		//  	await AsyncStorage.removeItem('f_training'+el.toString())
		...
		setTimeout(() => {
			...
			AsyncStorage.removeItem('f_student_evalue',(error)  =>{console.log(error)})
		...
		// 		AsyncStorage.removeItem('pr_training'+this.state.asyncId.toString())
		// 	}
		//  else {
		// 	for (let index = 1; index <= parseInt (indextotal); index++) {
				
		// 		await AsyncStorage.removeItem('pr_training'+index.toString())
...
// 	dispatch
// })
// export default connect(mapStateToProps,mapDispatchToProps)(ClotureFrein)
