...
export default class AccueilFreino extends React.Component {
...
async componentDidMount(){
  ...
  try {
    await AsyncStorage.multiRemove(['@heure','@heurefin',])
    console.log('yes');
    BackHandler.addEventListener('backPress', () => {return true});
    } catch (error) {
...
async cloture(){
  ...
  if (heure != null) {
  // this.currentF()
  Actions.clotureFrein(({stage:this.props.stage, typeF : this.props.typeF,asyncId:this.props.asyncId}))
  } else {
