...
const options = [
 ...
 class LoginGCam extends React.Component {
  constructor(props) {
		super(props);
		this.state={
			selectedButton: 'F',
      showChoices:false,
      index:1,
      indexProps:this.props.indexProps
		}
  ...
  homeGCam() {
    Actions.accueilGCAM({stage:this.props.stage,stageName : this.props.stageName,})
  }
  async nextStudent(){
    Actions.loginGcam()
  }
      ...
      <Modal 	
        ...
        >
          ...
          <View style={{
            ...
            <TouchableOpacity 
              onPress={()=>{
                Actions.loginGCam({stage:this.props.stage,typeF: this.props.typeF})
            ...
            <TouchableOpacity 
              onPress={()=>{
                this.setState({showChoices:false})
                this.sendProps()
              Actions.listeStudentGCAM({stage:this.props.stage,typeF: this.props.typeF})
            }}
  ...
  componentDidMount(){
    ...
    AsyncStorage.removeItem('gcam_totalStudent',(error)  =>{console.log(error)})
    console.log(this.props.createUser.indexStudent);
  }
    ...
    try {
         ...
         console.log(response);
          if (!response.success) {
            ...
            await AsyncStorage.setItem('@gcam_is_registered'+i.toString(), "true")
      ...
      onSubmit = async  (values) => {
        try {
          ...
          const value = await AsyncStorage.getItem('@gcam_is_registered'+this.props.createUser.indexStudent.toString())
            if (value === "true") {
          ...
          <Text style={{color:'#fff',fontSize:36 }}>
           ...
           <View style={{justifyContent:"center",flexDirection:'row'}}>
            ...
            <View style={{flexDirection:'row',paddingVertical:40, }}>
              ...
              <Text style={{ alignSelf: 'flex-start',color:'white',fontSize:30,fontWeight:"bold",left:300,top:-20}}>CAM DATA</Text>
              <Text style={{color:'#00B0F0',fontSize:20,fontStyle:"italic",left:250,top:-18}}>Powered By CleanData</Text>
              </View>
            </View>
