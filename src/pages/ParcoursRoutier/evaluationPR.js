...
export default class EvaluationPR extends React.Component {
    componentDidMount(){
                ...
                <View style={{flexDirection:'row',top:250}}>
                  <Card style={styles.Card1}>
                    <TouchableOpacity style={styles.touch1} 
                       onPress={()=>Actions.listeStudentPR({stage:this.props.stage,stageName : this.props.stageName,
                        typeF:"initial"})}
                    >
                  ...
                  >
                    <TouchableOpacity style={styles.touch1}
                       onPress={()=>Actions.listeStudentPR({stage:this.props.stage,
