...
const options = [
 ...
 class LoginParcours extends React.Component {
  constructor(props) {
		super(props);
		this.state={
			selectedButton: 'F',
  ...
  homeParcours() {
    ...
    Actions.listeStudentPR({stage:this.props.stage,typeF:this.props.typeF})
  }
  async nextStudent(){
    console.log(this.props.stage);
    Actions.loginP({stage:this.props.stage,typeF:this.props.typeF})
  }
  componentDidMount(){
    ...
    try {
         ...
         console.log(response);
          if (!response.success) {
            ...
            await AsyncStorage.setItem('@pr_is_registered'+i.toString(), "true")
      ...
      onSubmit = async  (values) => {
        try {
          ...
          const value = await AsyncStorage.getItem('@pr_is_registered'+this.props.createUser.indexStudent.toString())
            if (value === "true") {
          ...
          <Text style={{color:'#fff',fontSize:36 }}>
           ...
           <View style={{justifyContent:"center",flexDirection:'row'}}>
            ...
            <View style={{flexDirection:'row',paddingVertical:40, }}>
              ...
              <Text style={{color:'#00B0F0',fontSize:20,fontStyle:"italic",left:275,top:-18}}>Powered by CleanData</Text>
              </View>
            </View>
