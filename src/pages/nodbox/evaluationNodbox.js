...
export default class EvaluationNodbox extends React.Component {
    componentDidMount(){
      console.log(this.props.stageName+"rrrrrr");
            ...
            <View style={styles.container}>
                ...
                <View style={{flexDirection:'row',top:270}}>
                  <Card style={styles.Card3}>
                    <TouchableOpacity style={styles.touch1}
                      onPress={()=>Actions.listeStudentNB({stage:this.props.stage,stageName : this.props.stageName,
                        typeF:"simultane"})}
                    >
