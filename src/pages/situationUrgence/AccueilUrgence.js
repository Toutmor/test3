...
export default class AccueilUrgence extends React.Component {
...
async cloture(){
  ...
  if (heure != null) {
  // this.currentF()
  Actions.clotureUrg(({stage:this.props.stage, typeF : this.props.typeF,asyncId:this.props.asyncId}))
  } else {
